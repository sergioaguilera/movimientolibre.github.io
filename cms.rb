...
imprenta.url_sitio = 'http://www.movimientolibre.com'

# Nombre del sitio web
TITULO_SITIO          = 'Movimiento Libre'
imprenta.titulo_sitio = TITULO_SITIO

# Descripción del sitio web
DESCRIPCION_SITIO    = 'Colección de ideas.'
...
imprenta.publicaciones_directorios = %w{ apuntes articulos presentaciones contacto }
...
imprenta.publicaciones_etiquetas = { 'articulos' => "Artículos" }
...
menu_principal.agregar('Apuntes',        'apuntes/')
...
imprenta.publicaciones_por_pagina_maximo = 10
